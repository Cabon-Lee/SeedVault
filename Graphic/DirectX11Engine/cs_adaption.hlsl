...
{
    uint2 Res; // Resulotion of the qurter size target: x - width, y - height
    uint Domain; // Total pixel in the downscaled image
    uint GroupSize; // Number of groups dispached on the first pass
