...
cbuffer OffsetVectors : register(b1)
{
...
Texture2D gNormalDepthMap : TEXTURE : register(t0);
Texture2D gRandomVecMap : TEXTURE : register(t1);
...
float4 main(VertexOut pin) : SV_Target
{
    ...
    return (saturate(pow(access, 4.0f)) + 1) * 0.5;
}