...
IMGUI_IMPL_API void Void_ImGui_ImplDX11_Init(void* device, void* deviceContext)
{
    ImGui_ImplDX11_Init(static_cast<ID3D11Device*>(device), static_cast<ID3D11DeviceContext*>(deviceContext));
}
